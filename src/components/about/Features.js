...
export default function Features() {
  return (
    <div className="bg-white">
      <div className="mx-auto lg:mx-12 max-w-full py-6 px-4 sm:px-6 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:py-10 lg:px-8">
        <div>
          <h2 className="text-lg font-semibold text-myRed">Everything you need</h2>
