  ...
  return (
    <Link
      ...
      <div className="flex-shrink-0">
        <img id={data.id} className="h-96 w-full transition duration-900 ease-in-out object-cover" src={data.imageUrl} alt="" />
      </div>
      <div className="flex flex-1 flex-col justify-between bg-white p-6">
        <div className="flex-1">
          ...
          <a href={data.href} className="mt-2 block">
            <p id={index} className="lg:text-4xl pt-4 pb-6 sm:text-2xl text-xl font-semibold transition duration-400 ease-in-out text-gray-900">{data.title}</p>
